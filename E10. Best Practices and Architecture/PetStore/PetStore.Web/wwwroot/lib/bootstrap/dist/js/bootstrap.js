...
(function (global, factory) {
  ...
  class Dropdown extends BaseComponent {
    ...
    _createPopper(parent) {
      ...
      _popper = Popper__namespace.createPopper(referenceElement, _menu, popperConfig);
  ...
  class Tooltip extends BaseComponent {
    ...
    show() {
      ...
      if (_popper) {
        ...
        _popper = Popper__namespace.createPopper(_element, tip, _getPopperConfig(attachment));
      }
