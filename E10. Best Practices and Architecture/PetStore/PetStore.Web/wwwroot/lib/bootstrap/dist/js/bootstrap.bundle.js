  ...
  */
  ...
  class Dropdown extends BaseComponent {
    ...
    _createPopper(parent) {
      ...
      } else if (isElement$1(_config.reference)) {
      ...
      _popper = createPopper(referenceElement, _menu, popperConfig);
  ...
  class Tooltip extends BaseComponent {
    ...
    show() {
      ...
      if (_popper) {
        ...
        _popper = createPopper(_element, tip, _getPopperConfig(attachment));
      }
